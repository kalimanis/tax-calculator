...
const FAQ_SCHEMA = [
  ...
  },
  {
    ...
    acceptedAnswer: {
      "@type": "Answer",
      text: "Οι υπολογισμοί γίνονται αποκλειστικά στη συσκευή σου — κανένα ποσό ή προσωπικό δεδομένο δεν αποστέλλεται σε server. Χρησιμοποιούμε ανώνυμα στατιστικά επισκεψιμότητας χωρίς cookies.",
    },
  },
];
