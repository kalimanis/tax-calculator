...
export const LABELS = {
  ...
  regime: {
    misthotos: "Μισθωτός (Άρθ. 12 §1)",
    misthotosShort: "Μισθωτός",
  ...
  results: {
    ...
    netMonthly: "Καθαρό Μηνιαίο Εισόδημα",
    monthlySavings: "Μηνιαίες Υποχρεώσεις",
...
export const TOOLTIPS = {
  misthotos:
    "Μισθωτός εργαζόμενος (Άρθ. 12 §1 ΚΦΕ). Φορολόγηση εισοδήματος μισθωτών υπηρεσιών με δικαίωμα αφορολόγητου.",
  mplokaki:
  ...
  monthlySavings:
    "Το ποσό που πρέπει να βάζετε στην άκρη κάθε μήνα για να καλύψετε τη φορολογική σας υποχρέωση (φόρος + ΕΦΚΑ).",
  changes2026:
